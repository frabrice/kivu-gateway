  ...
  if (!article) {
    return (
      <div className="mx-auto max-w-3xl px-4 py-24 text-center sm:px-6 lg:px-8">
        ...
        <Link to="/journal" className="mt-6 inline-flex items-center gap-1.5 text-sm font-bold text-blue-600">
    ...
    <>
      <div className="relative h-72 w-full overflow-hidden sm:h-96">
        ...
        <div className="absolute inset-x-0 bottom-0 mx-auto max-w-4xl px-4 pb-8 sm:px-6 lg:px-8">
          <Link to="/journal" className="mb-4 inline-flex items-center gap-1.5 text-xs font-semibold text-white/80 hover:text-white">
