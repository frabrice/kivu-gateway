...
import { ArrowRight, Briefcase, CalendarDays, Newspaper, Store } from 'lucide-react'
import { useDocumentTitle } from '../../hooks/useDocumentTitle'
import { useData } from '../../data/store'

export default function AdminOverview() {
  useDocumentTitle('Admin Overview')
  const { businesses, events, opportunities, articles } = useData()
  ...
  return (
    <div>
      ...
      <p className="mt-1 text-sm text-navy-400">Changes here are stored for this browser session only (no backend yet).</p>
