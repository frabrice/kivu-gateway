...
export default function Opportunities() {
  useDocumentTitle('Opportunities', 'Jobs and tenders from companies and NGOs working in Goma, Gisenyi and North Kivu.')
  ...
  return (
    <>
      ...
      <section className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        {filtered.length === 0 ? (
          <p className="mt-12 text-center text-sm text-navy-400">No opportunities match that filter right now.</p>
        ) : (
      ...
      <CTABand
        ...
        primaryLabel="Post an Opportunity"
      />
    </>
  )
}
